...
struct routing {
    ...
    struct route{
         ...
         */
        route(const dhyara::peer_address& dst, const dhyara::peer_address& via);
            
        /**
         * destination address of this route
         */
        inline const dhyara::peer_address& dst() const { return _dst; }
        /**
         * intermediate node address of this route
         */
        inline const dhyara::peer_address& via() const { return _via; }
    ...
    struct next_hop{
         ...
         * \param delay delay
         */
        inline next_hop(dhyara::peer_address via, delay_type delay): _via(via), _delay(delay){}
        /**
         * Comparator
         */
    ...
    typedef std::map<dhyara::peer_address, next_hop> next_vector_type;
     ...
     */
    bool exists(const dhyara::peer_address& dst) const;
    /**
     ...
     */
    dhyara::routing::next_hop next(const dhyara::peer_address& dst) const;
    /**
    ...
    private:
        ...
        next_hop calculated_next(dhyara::peer_address dst) const;
        bool update_next(dhyara::peer_address dst);
};
