...
dhyara::tools::traceroute::traceroute(dhyara::network& network, const dhyara::peer_address& target): _network(network), _target(target), _conn_lost(0), _conn_reply(0), _sequence(1){
...
void dhyara::tools::traceroute::reply(const dhyara::peer_address&, const dhyara::packets::echo_reply& reply){
