...
const dhyara::neighbour& dhyara::neighbourhood::add1(const dhyara::neighbour& p){
...
const dhyara::neighbour& dhyara::neighbourhood::add1(const dhyara::address& addr, uint8_t ch, bool enc){
    return add1(dhyara::neighbour(addr));
}

const dhyara::neighbour& dhyara::neighbourhood::add1(const std::string& addr, std::uint8_t ch, bool enc){
    return add1(dhyara::address(addr), ch, enc);
}
